...
@endsection
 ...
 @section('custom-js')
    ...
    document.getElementById('uploadDocumentForm').addEventListener('submit', function(event) {
        ...
        // const docsnumbererror = document.getElementById ("documentNumberError")
        // const docsnumber = document.getElementById ("dNumber")
        // const docsValue = document.getElementById ("document-number")
