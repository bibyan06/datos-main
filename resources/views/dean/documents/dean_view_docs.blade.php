            ...
            <div class="doc-container">
                <div class="view-documents">
                    <div class="doc-description">
                        <a href="{{ route('home.dean') }}" class="back-icon" aria-label="Go back">
                    ...
                    <div class="viewing-btn">
                        ...
                        <!-- <button class="edit-btn" onclick="location.href='{{ route('dean.documents.dean_edit_docs', $document->document_id) }}'">Edit</button> -->
